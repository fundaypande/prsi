    ...
    if(value.jk == 0)
      jk = 'Perempuan';
        ...
        rows = rows + '<td>'+value.user.name+'</td>';
  	  	rows = rows + '<td data-id="'+value.id+'" data-sekolah="'+value.sekolah.id+'">';
...
$(".crud-submit").click(function(e) {
    ...
    $.ajax({
        ...
        demo.showNotification('top','right','Berhasil menambahkan data Atlit', 1);
    });
});
...
$("#hapus").click(function(e) {
    ...
    $.ajax({
        ...
        c_obj.remove();
        demo.showNotification('top','right','Berhasil menghapus data atlit', 1);
        getPageData();
    });
});
...
$(".crud-submit-edit").click(function(e) {
    ...
    $.ajax({
        ...
        getPageData();
        $(".modal").modal('hide');
        demo.showNotification('top','right','Berhasil mengedit data atlit', 1);
    });
});
